Operation =6
Option =0
Where ="((([Histórico Matrícula].Status)=\"Desistente\" Or ([Histórico Matrícula].Status"
    ")=\"Eliminado\" Or ([Histórico Matrícula].Status)=\"Transferido\") AND (([Histór"
    "ico Matrícula].Data) Between #4/1/2017# And #4/30/2017#))"
Begin InputTables
    Name ="Salas"
    Name ="Alunos"
