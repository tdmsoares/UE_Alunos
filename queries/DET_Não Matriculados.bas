Operation =1
Option =0
Where ="(((Alunos.Status)=\"Desistente\" Or (Alunos.Status)=\"Eliminado\" Or (Alunos.Sta"
    "tus)=\"Transferido\") AND (([Histórico Matrícula].Status)=\"Eliminado\" Or ([His"
    "tórico Matrícula].Status)=\"Transferido\" Or ([Histórico Matrícula].Status)=\"De"
    "sistente\"))"
Begin InputTables
    Name ="Salas"
    Name ="Alunos"
