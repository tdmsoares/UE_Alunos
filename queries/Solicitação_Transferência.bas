Operation =1
Option =0
Where ="((([Transferência-Remanejamento].Solicitação)=\"Transferência\") AND ((Alunos.St"
    "atus)=\"Matriculado\"))"
Begin InputTables
...
Begin OutputColumns
    ...
    Expression ="[Transferência-Remanejamento].UE"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="[Transferência-Remanejamento].UE"
        dbLong "AggregateType" ="-1"
    End
End
Begin
