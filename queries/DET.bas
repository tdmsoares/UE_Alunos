...
Where ="(((Alunos.Status)<>\"Matriculado\") AND (([Histórico Matrícula].Status)=\"Elimin"
    ...
    "].Status)=\"Desistente\")) OR (((Alunos.Status)=\"Matriculado\") AND (([Históric"
    "o Matrícula].Status)=\"Eliminado\" Or ([Histórico Matrícula].Status)=\"Transferi"
    "do\" Or ([Histórico Matrícula].Status)=\"Desistente\") AND (([Histórico Matrícul"
    "a].[Matrícula Anterior])=True))"
Begin InputTables
    Name ="Salas"
    Name ="Alunos"
